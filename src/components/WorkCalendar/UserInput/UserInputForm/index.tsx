...
export const UserInputForm = () => {
	...
	const save = (formValue: CalendarEventForm) => {
		...
		if (selectedField === 'workTimes') {
			const sh = formValue.workTimes.startTime?.hour();
			const sm = formValue.workTimes.startTime?.minute();
			const eh = formValue.workTimes.endTime?.hour();
			const em = formValue.workTimes.endTime?.minute();
